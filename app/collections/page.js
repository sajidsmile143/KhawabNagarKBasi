    ...
    <div className="fade-in" style={{ padding: '3rem 1rem', minHeight: '100vh' }}>
      <div className="container" style={{ maxWidth: '1200px' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '3rem', borderBottom: '1px solid #eee', paddingBottom: '2rem' }}>
          <span style={{ color: 'var(--accent)', letterSpacing: '4px', fontSize: '0.75rem', textTransform: 'uppercase', fontWeight: 'bold' }}>FULL COLLECTION</span>
          <h1 className="serif" style={{ fontSize: '3rem', margin: '0.5rem 0' }}>All Works</h1>
        </div>
        ...
        {poems.length > 0 ? (
          ...
          <div style={{ textAlign: 'center', padding: '4rem', color: 'var(--text-muted)' }}>
            <p className="urdu" style={{ fontSize: '1.5rem' }}>Abhi koi shayari maujood nahi hai.</p>
          </div>
        )}
      </div>
    </div>
